...
class Snacks {
  ...
  Snacks.fromJson(Map<String, dynamic> json) {
    ...
    if (json["pivot"] is Map) {
      pivot = json["pivot"] == null ? null : Pivot6.fromJson(json["pivot"]);
    }
  }
...
class Pivot6 {
  ...
  Pivot6({this.packageId, this.productId});

  Pivot6.fromJson(Map<String, dynamic> json) {
